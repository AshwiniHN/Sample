...
<xsl:if test='((/client:EAIBrokerProcessorProcessRequest/client:TxnMessage/ns3:ListOfIsg_Sf_Opportunity_Io/ns3:Opportunity/ns3:AccountId !="") and (/client:EAIBrokerProcessorProcessRequest/@Operation !="Delete") )'>
<ns1:Dependency>
<ns1:DependencyType>
<xsl:text disable-output-escaping="no">Account</xsl:text>
</ns1:DependencyType>
<ns1:DependencyKey>
<xsl:value-of select="/client:EAIBrokerProcessorProcessRequest/client:TxnMessage/ns3:ListOfIsg_Sf_Opportunity_Io/ns3:Opportunity/ns3:AccountId"/>
</ns1:DependencyKey>
</ns1:Dependency>
</xsl:if>
<xsl:if test='((/client:EAIBrokerProcessorProcessRequest/client:TxnMessage/ns3:ListOfIsg_Sf_Opportunity_Io/ns3:Opportunity/ns3:ContactId !="") and  (/client:EAIBrokerProcessorProcessRequest/@Operation !="Delete"))'>
<ns1:Dependency>
<ns1:DependencyType>
<xsl:text disable-output-escaping="no">Contact</xsl:text>
</ns1:DependencyType>
<ns1:DependencyKey>
<xsl:value-of select="/client:EAIBrokerProcessorProcessRequest/client:TxnMessage/ns3:ListOfIsg_Sf_Opportunity_Io/ns3:Opportunity/ns3:ContactId"/>
</ns1:DependencyKey>
</ns1:Dependency>
</xsl:if>
</ns1:ListOfDependency>
