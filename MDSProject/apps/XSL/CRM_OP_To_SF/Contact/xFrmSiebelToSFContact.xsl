...
<xsl:stylesheet version="1.0" xmlns:aia="http://www.oracle.com/XSL/Transform/java/oracle.apps.aia.core.xpath.AIAFunctions" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:bpel="http://docs.oasis-open.org/wsbpel/2.0/process/executable" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ns5="http://SalesforceIntegration/contact_SFIds" xmlns:bpm="http://xmlns.oracle.com/bpmn20/extensions" xmlns:od="urn:/crmondemand/xml/account" xmlns:plnk="http://schemas.xmlsoap.org/ws/2003/05/partner-link/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tns="urn:enterprise.soap.sforce.com" xmlns:ora="http://schemas.oracle.com/xpath/extension" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:ns3="http://SalesforceIntegration/account_SFIds" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:hwf="http://xmlns.oracle.com/bpel/workflow/xpath" xmlns:ns2="http://www.siebel.com/xml/ISGSFContactIO" xmlns:med="http://schemas.oracle.com/mediator/xpath" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ids="http://xmlns.oracle.com/bpel/services/IdentityService/xpath" xmlns:client="http://xmlns.oracle.com/InsertContactSFProvABCSImpl" xmlns:xdk="http://schemas.oracle.com/bpel/extension/xpath/function/xdk" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:fns="urn:fault.enterprise.soap.sforce.com" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ns4="http://schemas.oracle.com/bpel/extension" xmlns:ns1="http://xmlns.oracle.com/OP_SF_Contact/InsertContactSFProvABCSImpl/InsertContactSFProvABCSImpl" xmlns:ens="urn:sobject.enterprise.soap.sforce.com" xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap" xmlns:ns6="http://SalesforceProject/SFEndpointProcess" exclude-result-prefixes="xsl ns5 od plnk ns3 ns2 client xsd ns4 ns6 ns1 soap tns fns aia bpws xp20 bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref ldap">
...
<xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/dvm/PreferredLanguageCodeDVMSiebelToSF.dvm&quot;,&quot;Siebel&quot;,ns2:PreferredLanguageCode,&quot;Salesforce&quot;,&quot;No Value&quot;)"/>
</ens:Preferred_Language__c>
</xsl:if>
...
<xsl:if test="ns2:ListOfCutAddress/ns2:CutAddress/ns2:City !=''">
<ens:OtherCity>
<xsl:value-of select="ns2:ListOfCutAddress/ns2:CutAddress/ns2:City"/>
</ens:OtherCity>
</xsl:if>
<xsl:if test="ns2:ListOfCutAddress/ns2:CutAddress/ns2:Country !=''">
<ens:OtherCountryCode>
<xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/dvm/Country_SFToSBL.dvm&quot;,&quot;SBL&quot;,ns2:ListOfCutAddress/ns2:CutAddress/ns2:Country,&quot;SALESFORCE&quot;,&quot;No Value&quot;)"/>
</ens:OtherCountryCode>
</xsl:if>
<xsl:if test="ns2:ListOfCutAddress/ns2:CutAddress/ns2:State !=''">
<ens:OtherState>
<xsl:call-template name="splitstate">
<xsl:with-param name="state" select="dvm:lookupValue('oramds:/apps/dvm/State_SFToSBL.dvm','SBL',ns2:ListOfCutAddress/ns2:CutAddress/ns2:State,'SALESFORCE','No Code Found')"/>
</xsl:call-template>
</ens:OtherState>
</xsl:if>
<xsl:if test="ns2:ListOfCutAddress/ns2:CutAddress/ns2:StreetAddress !=''">
<ens:OtherStreet>
<xsl:value-of select='concat(ns2:ListOfCutAddress/ns2:CutAddress/ns2:StreetAddress,"&#x000d;&#x000a;",ns2:ListOfCutAddress/ns2:CutAddress/ns2:StreetAddress2,"&#x000d;&#x000a;",ns2:ListOfCutAddress/ns2:CutAddress/ns2:StreetAddress3)'/>
</ens:OtherStreet>
</xsl:if>
<xsl:if test="ns2:ListOfCutAddress/ns2:CutAddress/ns2:PostalCode !=''">
<ens:OtherPostalCode>
<xsl:value-of select="ns2:ListOfCutAddress/ns2:CutAddress/ns2:PostalCode"/>
</ens:OtherPostalCode>
</xsl:if>
</xsl:when>
<xsl:otherwise>
...
<ens:MailingState>
<xsl:call-template name="splitstate">
<xsl:with-param name="state" select="dvm:lookupValue('oramds:/apps/dvm/State_SFToSBL.dvm','SBL',ns2:ListOfContact_BusinessAddress/ns2:Contact_BusinessAddress/ns2:State,'SALESFORCE','No Code Found')"/>
</xsl:call-template>
</ens:MailingState>
</xsl:if>
<xsl:if test="ns2:ListOfContact_BusinessAddress/ns2:Contact_BusinessAddress/ns2:StreetAddress !=''">
<ens:MailingStreet>
<xsl:value-of select="concat(ns2:ListOfContact_BusinessAddress/ns2:Contact_BusinessAddress/ns2:StreetAddress,ns2:ListOfContact_BusinessAddress/ns2:Contact_BusinessAddress/ns2:StreetAddress2,ns2:ListOfContact_BusinessAddress/ns2:Contact_BusinessAddress/ns2:StreetAddress3)"/>
</ens:MailingStreet>
</xsl:if>
...
<xsl:variable name="ModifiedDateTime" select="concat($Year,'-',$Month,'-',$Date,'T',$Time)"/>
...
<xsl:variable name="secondsubstring" select="substring-before($after,'-')"/>
<xsl:variable name="modifiedstate" select="concat($before,'-',$secondsubstring)"/>
<xsl:choose>
