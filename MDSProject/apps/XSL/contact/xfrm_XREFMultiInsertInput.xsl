...
<xsl:choose>
<xsl:when test="position() = 1  and /ns2:ids/ns2:SFContactId">
<ns0:recType>
...
<ns0:refHostRowId>
<xsl:value-of select="/ns2:ids/ns2:OPContactId"/>
</ns0:refHostRowId>
</xsl:when>
</xsl:choose>
<xsl:choose>
<xsl:when test="position() = 2  and /ns2:ids/ns2:CutAddressIdInXREF">
<ns0:recType>
...
<ns0:refHostRowId>
<xsl:value-of select="/ns2:ids/ns2:OPCutAddressId"/>
</ns0:refHostRowId>
</xsl:when>
</xsl:choose>
</ns0:operation>
