...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.8(build 150622.2350.0222) AT [TUE FEB 02 21:35:44 MST 2016]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <ns7:SflogCollection>
      <xsl:for-each select="/ns3:SFLogObjectEvents/ns3:accountUpdateEvents">
