...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.8(build 150622.2350.0222) AT [WED MAY 18 17:36:55 CDT 2016]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="Id"
                select="/xsdLocal1:ListOfIsg_Sf_Opportunity_Io/xsdLocal1:Opportunity/xsdLocal1:ListOfOpportunity_Organization/xsdLocal1:Opportunity_Organization/xsdLocal1:Id"/>
  <xsl:template match="/">
    <xsdLocal1:ListOfIsg_Sf_Opportunity_Io>
      <xsdLocal1:Opportunity>
        <xsdLocal1:ListOfOpportunity_Organization>
          <xsl:apply-templates select="$tempInput.OPListOfOpty/xsdLocal1:ListOfIsg_Sf_Opportunity_Io/xsdLocal1:Opportunity/xsdLocal1:ListOfOpportunity_Organization/xsdLocal1:Opportunity_Organization[not(xsdLocal1:Id =$Id)]"/>
        </xsdLocal1:ListOfOpportunity_Organization>
      </xsdLocal1:Opportunity>
    </xsdLocal1:ListOfIsg_Sf_Opportunity_Io>
  </xsl:template>
