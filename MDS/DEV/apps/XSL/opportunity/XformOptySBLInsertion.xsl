...
<xsl:stylesheet exclude-result-prefixes="xsi xsl ns2 ns1 wsdl plnk client xsd ns10 xsdLocal1 xsdLocal2 tns1 soapenc soap tns xsdLocal3 xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref ldap"
  ...
  <xsl:template match="/ns10:EventsToProcess/ns10:ListOfEvent/ns10:Event[ns10:Operation !='Delete']">
    ...
    <xsl:choose>
      <xsl:when test="(string-length($VarIds/ns2:MultiIds/ns2:ids[ns2:SFPartnerID=$PartnerID]/ns2:SBLPartnerID) = 0.0 and string-length($VarIds/ns2:MultiIds/ns2:ids[ns2:SFAccountId=$AccountId]/ns2:SiebelAccId) != 0.0 and string-length($VarIds/ns2:MultiIds/ns2:ids[ns2:SFOptyId=$Opportunity_Id]/ns2:SiebelOptyId) != 0.0) ">
