...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.8(build 150622.2350.0222) AT [THU MAY 19 10:11:48 CDT 2016]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="Id"
                select="$tempInput.OPListOfOpty/xsdLocal1:ListOfIsg_Sf_Opportunity_Io/xsdLocal1:Opportunity/xsdLocal1:ListOfOpportunity_Organization/xsdLocal1:Opportunity_Organization/xsdLocal1:Id"/>
  <xsl:template match="/">
    <xsdLocal2:ListOfIsg_Sf_Opportunity_Io>
      <xsdLocal2:Opportunity>
        <xsdLocal2:Id>
          <xsl:value-of select="$tempInput.OPListOfOpty/xsdLocal1:ListOfIsg_Sf_Opportunity_Io/xsdLocal1:Opportunity/xsdLocal1:Id"/>
        </xsdLocal2:Id>
        <xsdLocal2:ListOfOpportunity_Organization>
          <xsl:apply-templates select="/xsdLocal1:ListOfIsg_Sf_Opportunity_Io/xsdLocal1:Opportunity/xsdLocal1:ListOfOpportunity_Organization/xsdLocal1:Opportunity_Organization[(not(xsdLocal1:Id =$Id) and  xsdLocal1:Id !='0-R9NH') ]"/>
        </xsdLocal2:ListOfOpportunity_Organization>
      </xsdLocal2:Opportunity>
    </xsdLocal2:ListOfIsg_Sf_Opportunity_Io>
  </xsl:template>
  <xsl:template match="/xsdLocal1:ListOfIsg_Sf_Opportunity_Io/xsdLocal1:Opportunity/xsdLocal1:ListOfOpportunity_Organization/xsdLocal1:Opportunity_Organization">
    <xsdLocal2:Opportunity_Organization>
      <xsdLocal2:Id>
