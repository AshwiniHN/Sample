      ...
      <db:InputParameters>
         <db:P_EVENT_DTLS>
            ...
            <xsl:if test="$OptyLineId != ''">
               <db:P_EVENT_DTLS_ITEM>
                  ...
                  <xsl:for-each select="$sflog_objectevents/ns3:SFLogObjectEvents/ns3:optyLineUpdateEvents">
                     <xsl:if test="ns3:OBJECTID = $OptyLineId">
                        <db:SFLOGID>
         ...
         <db:P_EVENT_BLOCK_DTLS>
            <xsl:for-each select="/tns:retrieveResponse/tns:result">
               ...
               <xsl:for-each select="$sflog_objectevents/ns3:SFLogObjectEvents/ns3:optyLineUpdateEvents">
               <xsl:choose>
                  <xsl:when test="ns3:OBJECTID = $OptyLineId1">
