...
<?oracle-xsl-mapper
  ...
  <mapSources>
    ...
    <source type="WSDL">
      ...
      <param name="Invoke_populateBrokerdata_InputVariable.InputParameters" />
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.8(build 150622.2350.0222) AT [TUE FEB 02 03:02:56 MST 2016]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:param name="Invoke_populateBrokerdata_InputVariable.InputParameters"/>
  <xsl:template match="/">
    <ns7:SflogCollection>
      <xsl:for-each select="/ns3:SFLogObjectEvents/ns3:accountContactAssocInsertEvents">
        ...
        <xsl:variable name="sfLogIDInBrokerData"
                      select="$Invoke_populateBrokerdata_InputVariable.InputParameters/db:InputParameters/db:P_EVENT_DTLS/db:P_EVENT_DTLS_ITEM[db:SFLOGID = $sfLogIDInSFObject]/db:SFLOGID"/>
