...
<xsl:text disable-output-escaping="no">OpportunityContact</xsl:text>
</xsl:attribute>
<xsl:choose>
<xsl:when test="/client:EAIBrokerProcessorProcessRequest/client:TxnMessage/@Operation ='OptyContRole Sync On'">
<xsl:attribute name="Operation">
<xsl:text disable-output-escaping="no">Association</xsl:text>
</xsl:attribute>
</xsl:when>
<xsl:when test="/client:EAIBrokerProcessorProcessRequest/client:TxnMessage/@Operation ='OptyContRole Delete'">
<xsl:attribute name="Operation">
...
<ns1:DependencyKey>
<xsl:value-of select="/client:EAIBrokerProcessorProcessRequest/client:TxnMessage/ns3:ListOfIsg_Sf_Opportunity_Io/ns3:Opportunity/ns3:ListOfOpportunity_ContactRole/ns3:Opportunity_ContactRole[1]/ns3:Id"/>
</ns1:DependencyKey>
<ns1:Operation>
<xsl:text disable-output-escaping="no">Sync On</xsl:text>
</ns1:Operation>
