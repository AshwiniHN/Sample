      ...
      <ns3:SFLogObjectEvents>
         <xsl:for-each select="/ns3:SFLogObjectEvents/ns3:productPriceBook">
            <ns3:productPriceBook>
               ...
               <ns3:OBJECTTYPE>
                  <xsl:value-of select="ns3:OBJECTTYPE"/>
               </ns3:OBJECTTYPE>
               <ns3:OPERATION>
